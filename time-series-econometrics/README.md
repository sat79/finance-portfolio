...
**Financial question:** Does multivariate information improve historical GDP-growth forecasts?

**Finding:** VAR wins the validation comparison. Cointegration rank is zero, so VECM adds no error-correction relationship.
