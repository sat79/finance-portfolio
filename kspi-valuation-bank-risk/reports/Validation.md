...
## Geographic analysis extension — 13 September 2026

A new calculation validates the three-row panel, accepts losses, reconciles both years to the existing consolidated group income controls, and calculates the geographic profit bridge. The scope is reported historical arithmetic; it does not validate an expansion forecast. Existing valuation inputs are unchanged.
